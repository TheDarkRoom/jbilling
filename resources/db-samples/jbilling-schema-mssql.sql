...
(
            id INT NOT NULL,
            user_id INT NULL,
            aba_routing VARCHAR (9) NOT NULL,
...
(
            ...
            total_invoiced FLOAT NULL,
            total_paid FLOAT NULL,
            total_not_paid FLOAT NULL,
            OPTLOCK INT NOT NULL,
...
(
            ...
            dynamic_balance FLOAT NULL,
            credit_limit FLOAT NULL,
            auto_recharge FLOAT NULL,
            OPTLOCK INT NOT NULL,
...
(
            ...
            total_payouts FLOAT NOT NULL,
            percentage_rate FLOAT NULL,
            referral_fee FLOAT NULL,
            fee_currency_id INT NULL,
            one_time SMALLINT NOT NULL,
            period_unit_id INT NOT NULL,
            period_value INT NOT NULL,
            next_payout_date DATETIME NOT NULL,
            due_payout FLOAT NULL,
...
(
            ...
            refunds_amount FLOAT NOT NULL,
            balance_left FLOAT NOT NULL,
            payment_id INT NULL,
            partner_id INT NULL,
            OPTLOCK INT NOT NULL,
