...
(
    ...
    dynamic_balance DOUBLE,
    credit_limit DOUBLE,
    auto_recharge DOUBLE,
    OPTLOCK MEDIUMINT NOT NULL,
    PRIMARY KEY(id),
...
(
    ...
    balance DOUBLE,
    carried_balance DOUBLE NOT NULL,
...
(
    ...
    payments_amount DOUBLE NOT NULL,
    refunds_amount DOUBLE NOT NULL,
